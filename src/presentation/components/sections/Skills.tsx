      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card>
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-zinc-100">Technologies</h3>
          </div>
          <div className="space-y-4">
            ...
            <div>
              <p className="text-zinc-400">{t.skills.familiar}</p>
            </div>
          </div>
        </Card>
        ...
        <Card>
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-zinc-100">{t.skills.advancedGitTitle}</h3>
          </div>
        ...
        <Card>
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-zinc-100">{t.skills.dockerTitle}</h3>
          </div>
          <p className="text-zinc-400 leading-relaxed">
            {t.skills.dockerDesc}
          </p>
